...
var LR_ssl = 1;
var LR_Tick='12959d2e10b54f4499389364d3b1c972';
var LR_lng = 'cn';
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&MOCJ=FGBE&NPDK=GHBE&OQDK=HIBF&JLOG='+ lr_para3 + '&s=' + LR_sSize;
